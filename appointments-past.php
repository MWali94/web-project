...
<form action="download.php" method="post" style="margin: 20px 0;">
    <input type="submit" name="download" value="Download All Data" />
  </form>
...
$query = "SELECT p.name, a.date, a.time, a.reason 
          ...
          WHERE a.date < '$today' ORDER BY a.date DESC";

$result = $conn->query($query);

echo "<h2>Past Appointments</h2><ul>";
